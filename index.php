...
<body>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        ...
        <p class="lead">Objetivo: Desenvolver aplicações WEB utilizando <q>servidor apache, linguagem PHP, biblioteca
            jQuery, acesso a banco de dados e técnicas de orientação a objetos seguindo o padrão MVC para desenvolver
            aplicações completas.</q></p>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <details>
                        <summary>Alguns detalhes sobre o trabalho</summary>
                             <p>Para realizar a aplicação de novos elementos foi utilizado o site <a href="https://developer.mozilla.org/pt-BR/docs/Web/HTML/Element">Developer</a></p>
                    </details>
                    
                <footer><h4>Trabalho realizado por Lucas Alexander da turma 1228<h4></footer> 
                <dialog open>
                <p>Fim do index</p>
            </dialog>
            </div>
